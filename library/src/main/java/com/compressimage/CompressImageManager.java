...
import com.compressimage.core.CompressImageUtil;
import com.compressimage.listener.CompressImage;
import com.compressimage.listener.CompressResultListener;
...
public class CompressImageManager implements CompressImage {
    ...
    private List<Photo> images; // 要压缩的图片集合
    ...
    private CompressImageManager(Context context, CompressConfig config,
                                 List<Photo> images, CompressListener listener) {
    ...
    public static CompressImage build(Context context, CompressConfig config,
                                      List<Photo> images, CompressImage.CompressListener listener) {
